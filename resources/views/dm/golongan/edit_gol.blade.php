...
<title>SIMPP | Edit Data Golongan</title>
@section('content')
    <div class="mb-3">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
              <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0 text-warning">Edit Data Golongan <i class="bx bx-file"></i
                    ></h5>
              </div>
              <div class="card-body">
                <form method="POST" action="/golongan/{{ $data->id_golongan }}">
                    @csrf
                    @method('put')
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <input
                          ...
                          id="nama_golongan"
                          name="nama_golongan"
                          value="{{ old('nama_golongan', $data->nama_golongan) }}"
                        />
                        @error('nama_golongan')
