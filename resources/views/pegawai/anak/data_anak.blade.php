                ...
                <div class="col-12 col-sm-6">
                  <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                      <li><a class="dropdown-item" href="/exportanak"target="_blank">PDF <i class='bx bxs-file-pdf' ></i></a></li>
                      <li><a class="dropdown-item" href="{{ route('anak.excel') }}" target="_blank">Excel <i class='bx bx-file'></i></i></a></li>
                    </ul>
                  </div>
                </div>
