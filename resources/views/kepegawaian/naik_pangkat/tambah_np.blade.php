...
<title>SIMPP | Tambah Data Kenaikan Pangkat PNS Satpol PP & Damkar Tapin</title>
@section('content')
    <div class="card">
        <div class="card-header">
        <h3 class="text-success">Masukkan Data PNS Yang Akan Menerima Kenaikan Pangkat</h3>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="col-sm-12">
                    <div class="card">
                        <form action="/naik_pangkat" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                               ...
                               @enderror
                                  ...
                                  <div class="form-group mt-4">
                                    ...
                                    <input type="text" name="pangkat_baru" id="pangkat_baru" class="form-control @error('pangkat_baru')
                                      is-invalid
                                    @enderror" placeholder="Masukkan Pangkat Baru" value="{{ old('pangkat_baru') }}">
                                    @error('pangkat_baru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                  </div>                            
                                  ...
                                  <div class="col-sm-5 mt-4">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                        <input type="date" class="form-control col-3  @error('mulai_tanggal') is-invalid @enderror" id="mulai_tanggal" name="mulai_tanggal" value="{{ old('mulai_tanggal') }}">
                                        @error('mulai_tanggal')
                                        <div class="invalid-feedback">
                                        {{$message}}
                                        </div>
